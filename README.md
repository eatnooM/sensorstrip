...
I'd be curious to see how a Wiimote handles a sensor bar populated with 850nm emitters. https://wiibrew.org/wiki/Wiimote suggests 850nm will work with a Wiimote, but the LEDs will need to be a little brighter than with the 940nm ones they're intended for. Maybe there's a chance to try and get dual functionality out of a single device. Or maybe two of these is a more workable solution - after all, constantly adjusting spacing would be annoying and a lot of PCB fabs have a minimum quantity of 5 anyway.
